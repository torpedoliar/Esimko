    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          ...
          <div class="alert alert-<?php echo e((!empty($data['simpanan']->bukti_transaksi) ? 'success' : 'warning')); ?> mt-5" role="alert">
            ...
            <?php endif; ?>
            <button class="btn btn-<?php echo e((!empty($data['simpanan']->bukti_transaksi) ? 'primary' : 'warning')); ?>" data-target="#modal-upload" data-toggle="modal">Upload Bukti Pembayaran</button>
            <?php if(!empty($data['simpanan']->bukti_transaksi)): ?>
            <a href="<?php echo e(url('')); ?>" class="btn btn-secondary">Lihat Bukti Transaksi</a>
            <?php endif; ?>
          </div>
          <?php endif; ?>
        </div>
        <div class="card-footer">
          <a href="<?php echo e(url('main/simpanan')); ?>" class="btn btn-dark pull-right">Kembali</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card">
        <div class="card-body">
          <h5>Edit <?php echo e($data['simpanan']->group_transaksi); ?></h5>
          <hr>
          <form action="<?php echo e(url('main/transaksi/proses')); ?>" method="post">
            <?php echo e(csrf_field()); ?>

            <div class="form-group">
              <label>Jumlah <?php echo e($data['simpanan']->group_transaksi); ?> (Rp)</label>
              <input type="text" name="nominal" <?php echo e(($data['simpanan']->fid_status >= 3 ? 'disabled' : '')); ?> value="<?php echo e($data['simpanan']->nominal); ?>" style="text-align:right" class="form-control autonumeric" data-a-dec="," data-a-sep="." required >
            </div>
            <div class="form-group">
              <label>Keterangan</label>
              <textarea name="keterangan" <?php echo e(($data['simpanan']->fid_status >= 3 ? 'disabled' : '')); ?> class="form-control" style="height:100px"><?php echo e($data['simpanan']->keterangan); ?></textarea>
            </div>
            <input type="hidden" name="jenis_transaksi" value="<?php echo e($data['simpanan']->fid_jenis_transaksi); ?>">
            <input type="hidden" name="modul" value="<?php echo e($data['simpanan']->modul); ?>">
            <input type="hidden" name="id" value="<?php echo e($id); ?>">
            <?php if(in_array($data['simpanan']->fid_status,array('3','4'))): ?>
            ...
            <?php elseif($data['simpanan']->fid_status == 5 ): ?>
              <div class="alert alert-warning mt-2 mb-0">
            ...
            <div class="alert alert-secondary mt-2">
              <p class="text-muted m-0">Silahkan anda <?php echo e(($data['simpanan']->fid_status == 1 ? 'mengubah' : 'memproses ulang')); ?> atau membatalkan transaksi ini sebelum disetujui oleh petugas koperasi</p>
            </div>
            <div class="pull-right">
              <button class="btn btn-danger" type="button" name="button" onclick="batalkan()">Batalkan Transaksi</button>
              <button class="btn btn-primary" name="action" value="<?php echo e(($data['simpanan']->fid_status == 1 ? 'edit' : 'proses_ulang')); ?>"><?php echo e(($data['simpanan']->fid_status == 1 ? 'Edit Transaksi' : 'Proses Ulang')); ?></button>
            </div>
            <?php endif; ?>
          </form>
        </div>
...
<form action="<?php echo e(url('main/transaksi/proses_pembatalan')); ?>" id="proses_pembatalan" method="post">
  <?php echo e(csrf_field()); ?>
...
<div id="modal-upload" class="modal fade bs-example-modal-center" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?php echo e(url('main/transaksi/upload')); ?>" method="post" enctype="multipart/form-data">
        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/main/transaksi/simpanan/detail.blade.php ENDPATH**/ ?>