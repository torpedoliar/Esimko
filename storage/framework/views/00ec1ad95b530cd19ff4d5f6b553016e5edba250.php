  ...
  <div class="container-fluid">
    <div class="content-breadcrumb mb-2">
      <div class="page-title-box">
        <div class="media">
          <img src="<?php echo e(asset('assets/images/icon-page/qr.png')); ?>" class="avatar-md mr-3">
          <div class="media-body align-self-center">
            <h4 class="mb-0 font-size-18">Cetak Barcode Barang</h4>
            <p class="text-muted m-0">Halaman untuk mencetak barcode barang dari barang yang teserdia di toko</p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-2">
          <a class="btn btn-primary btn-block" href="<?php echo e(url('manajemen_stok/cetak/barcode_barang?mode=cetak')); ?>" >Cetak Barcode</a>
        </div>
      </div>
    </div>
          ...
          <tr>
            ...
            <td style="width:1px;white-space:nowrap">
              <div class="text-center">
                ...
                <form action="<?php echo e(url('manajemen_stok/cetak/barcode_barang/proses')); ?>" method="post" id="hapus<?php echo e($value->id); ?>">
  ...
  <div id="filter-barang" class="modal fade">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <form action="<?php echo e(url('manajemen_stok/cetak/barcode_barang/filter')); ?>" method="post">
          <?php echo e(csrf_field()); ?>
...
function edit_jumlah(id){
  ...
  $.ajax({
    url:'<?php echo e(url('manajemen_stok/cetak/barcode_barang/proses')); ?>',
    method:'POST',
    data:{
...
selected_kelompok = '<?php echo e((!empty(Session::get('filter_barcode_barang')) && Session::get('filter_barcode_barang')['kelompok'] !='all'  ? Session::get('filter_barcode_barang')['kelompok'] : 'all')); ?>';
selected_kategori = '<?php echo e((!empty(Session::get('filter_barcode_barang')) && Session::get('filter_barcode_barang')['kategori'] !='all' ? Session::get('filter_barcode_barang')['kategori'] : 'all')); ?>';
selected_subkategori = '<?php echo e((!empty(Session::get('filter_barcode_barang')) && Session::get('filter_barcode_barang')['sub_kategori'] !='all' ? Session::get('filter_barcode_barang')['sub_kategori'] : 'all')); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/manajemen_stok/cetak/barcode_barang/index.blade.php ENDPATH**/ ?>