            ...
            <tr>
              ...
              <td style="width:1px;white-space:nowrap">
                <div class="text-center">
                  <a href="<?php echo e(url('anggota/detail?anggota='.$data['anggota']->no_anggota.'&tab='.$tab.'&id='.$value->id)); ?>" class="text-dark"><i class="bx bx-search h3 m-0"></i></a>
                </div>
              </td>
            </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="mb-4 pt-4">
      <?php $__currentLoopData = $data['jenis-transaksi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="form-group">
          <p class="text-muted text-truncate mb-2">Sisa <?php echo e($value->jenis_transaksi); ?></p>
          <div class="font-size-15">Rp <?php echo e(number_format($value->sisa_pinjaman,0,'.',',')); ?></div>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <div class="form-group">
        <p class="text-muted text-truncate mb-2">Total Sisa Pinjaman</p>
        <div class="font-size-15">Rp <?php echo e(number_format($data['total-sisa'],0,'.',',')); ?></div>
      </div>
    </div>
  </div>
</div>
<?php /**PATH /var/www/html/resources/views/anggota/detail/pinjaman.blade.php ENDPATH**/ ?>