...
<div class="slider">
  ...
  <div class="container-fluid" style="padding-top:130px">
    <div class="row">
      ...
      <div class="col-md-6">
        <img src="<?php echo e(asset('assets/images/finance.png')); ?>" style="width:100%;">
      </div>
    </div>
  </div>
</div>
...
<section style="background:#ecf0f1" class="pt-5 pb-5">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-4">
        <img src="<?php echo e(asset('assets/images/simpanan.png')); ?>" style="width:100%">
      </div>
      <div class="col-md-7">
        ...
        <a href="<?php echo e(url('')); ?>" class="btn btn-primary mt-4">Pelajari Lebih Lanjut</a>
      </div>
    </div>
  </div>
</section>
<section class="pt-5 pb-5">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="<?php echo e(asset('assets/images/pinjaman.png')); ?>" style="width:100%">
      </div>
    </div>
  </div>
</section>
<section style="background:#ecf0f1;padding-bottom:100px" class="pt-5">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-4">
        <img src="<?php echo e(asset('assets/images/shopping.png')); ?>" style="width:100%">
      </div>
      <div class="col-md-8">
        <h4 class="title-fitur mb-3 mt-5">
...
<?php echo $__env->make('layouts.landing_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/landing_page/index.blade.php ENDPATH**/ ?>