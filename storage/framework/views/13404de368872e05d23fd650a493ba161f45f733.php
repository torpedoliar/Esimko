        ...
        <div class="page-title-box">
            <div class="media">
                ...
                <div class="media-body align-self-center">
                    <h4 class="mb-0 font-size-18">Laba Rugi</h4>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        let search = () => {
            ...
            $.post("<?php echo e(url('keuangan/laba_rugi/search')); ?>", {_token, bulan, bulan_akhir}, (result) => {
                $table.html(result);
            }).fail((xhr) => {
        ...
        let export_excel = () => {
            let bulan = $('#bulan').val();
            let bulan_akhir = $('#bulan_akhir').val();
            window.open("<?php echo e(url('keuangan/laba_rugi/export')); ?>?bulan=" + bulan + '&bulan_akhir=' + bulan_akhir, '_blank');
        }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/keuangan/laba_rugi/index.blade.php ENDPATH**/ ?>