...
<div class="container-fluid">
  ...
  <form action="<?php echo e(url('simpanan/sukarela/berkala/proses')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>

    <div class="card">
      <div class="card-header">
        <h5><?php echo e(($action=='add' ? 'Tambah' : 'Edit')); ?> Setoran Berkala Simpanan Sukarela</h5>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-5">
            <div style="border:#dfe4e9 dashed 2px ;padding:20px">
              ...
              <div class="row">
                <div class="col-auto">
                  <div class="avatar-wrapper" id="avatar" style="height:100px;width:100px">
                    <img src="<?php echo e((!empty($data['setoran-berkala']->avatar) ? asset('storage/'.$data['setoran-berkala']->avatar) : asset('assets/images/user-avatar-placeholder.png') )); ?>" alt="" />
                  </div>
                </div>
                <div class="col">
                  <div class="list-content">
                    <span>No. Anggota</span>
                    <div id="no_anggota" class="info-content"><?php echo (!empty($data['setoran-berkala']) ? $data['setoran-berkala']->no_anggota :'<hr>'); ?></div>
                  </div>
                  <div class="list-content">
                    <span>Nama Lengkap</span>
                    <div id="nama_lengkap" class="info-content"><?php echo (!empty($data['setoran-berkala']) ? $data['setoran-berkala']->nama_lengkap :'<hr>'); ?></div>
                  </div>
                </div>
              </div>
              ...
              <input type="hidden" name="no_anggota" value="<?php echo e((!empty($data['setoran-berkala']) ? $data['setoran-berkala']->no_anggota : '')); ?>" id="fid_anggota">
              <input type="hidden" id="anggota_id" value="<?php echo e((!empty($data['setoran-berkala']) ? $data['setoran-berkala']->id : '')); ?>" >
          ...
          <div class="col-md-7">
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Tanggal</label>
                  <input type="text" id="tanggal" onchange="calc_angsuran()" name="tanggal" autocomplete="off" value="<?php echo e((!empty($data['setoran-berkala']) ? \App\Helpers\GlobalHelper::dateFormat($data['setoran-berkala']->tanggal,'d-m-Y') : date('d-m-Y') )); ?>" class="datepicker form-control">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label>Jumlah Setoran</label>
                  <input type="text" id="jumlah_setoran" onkeyup="calc_angsuran()" style="text-align:right" class="form-control autonumeric" data-a-dec="," data-a-sep="." name="nominal" value="<?php echo e((!empty($data['setoran-berkala']) ? $data['setoran-berkala']->nominal : '0')); ?>"  >
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="select2 form-control" id="tipe_jadwal" name="tipe_jadwal">
                    ...
                    <option value="unlimited_range" <?php echo e((!empty($data['setoran-berkala']) && $data['setoran-berkala']->bulan_akhir=='Belum Ditentukan' ? 'selected' : '')); ?>>Unlimited Range</option>
                  </select>
                </div>
              </div>
              <div class="col-md-8">
                  ...
                  <div class="form-group">
                    ...
                    <div>
                      <div class="input-daterange input-group" data-provide="datepicker">
                        <input type="text" class="form-control" value="<?php echo e((!empty($data['setoran-berkala']) ? $data['setoran-berkala']->bulan_awal : date('m-Y'))); ?>" autocomplete="off" name="bulan_awal" placeholder="Dari Bulan" />
                        <input type="text" class="form-control" value="<?php echo e((!empty($data['setoran-berkala']) ? ($data['setoran-berkala']->bulan_akhir == 'Belum Ditentukan' ? date('m-Y') : $data['setoran-berkala']->bulan_akhir ) : date('m-Y'))); ?>" autocomplete="off" name="bulan_akhir" placeholder="Sampai Bulan" />
                      </div>
                    </div>
                  </div>
                </div>
                <div id="unlimited_range" class="form_jadwal">
                  <div class="form-group">
                    ...
                    <input type="text" class="monthpicker form-control" value="<?php echo e((!empty($data['setoran-berkala']) ? $data['setoran-berkala']->bulan_awal : date('m-Y'))); ?>" name="mulai_bulan" autocomplete="off" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea name="keterangan" class="form-control" style="height:70px"><?php echo e((!empty($data['setoran-berkala']) ? $data['setoran-berkala']->keterangan : '')); ?></textarea>
            </div>
            <div id="alert"></div>
          </div>
        </div>
      ...
      <div class="card-footer">
        ...
        <div class="pull-right">
          <a class="btn btn-secondary" href="<?php echo e(url('simpanan/sukarela/berkala')); ?>" >Kembali</a>
...
calc_angsuran();
<?php if(!empty($data['setoran-berkala'])): ?>
pilih_anggota('<?php echo e($data['setoran-berkala']->anggota_id); ?>');
<?php endif; ?>
...
function pilih_anggota(id){
  if(id=='show'){
    ...
    tanggal=$('#tanggal').val();
    bulan_sekarang=tanggal.substr(-7);
    $.get("<?php echo e(url('api/find_anggota')); ?>/"+id+"/"+bulan_sekarang,function(result){
      $('#anggota_id').val(id);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simpanan/berkala/form.blade.php ENDPATH**/ ?>