...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        let search_data = (page = 1) => {
            ...
            data.paginate = 10;
            data.page = page;
            $.post("<?php echo e(url('pos/laporan_penyesuaian/search')); ?>", data, (result) => {
                $table.html(result);
            }).fail((xhr) => {
        ...
        let export_Excel = () => {
            ...
            window.open("<?php echo e(url('pos/laporan_penyesuaian/excel')); ?>?" + data, '_blank');
        }

        let cetak = () => {
            let data = $form_search.serialize();
            window.open("<?php echo e(url('pos/laporan_penyesuaian/cetak')); ?>?" + data, '_blank');
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pos/laporan/penyesuaian/index.blade.php ENDPATH**/ ?>