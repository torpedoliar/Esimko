                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-middle table-custom">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $data['simpanan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td style="width:1px;white-space:nowrap">
                                            <div class="text-center">
                                                <a href="<?php echo e(url('main/simpanan/detail?id='.$value->id)); ?>" class="text-dark"><i class="bx bx-search-alt h3 m-0"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mb-4">
                            <?php echo e($data['simpanan']->links('include.pagination', ['pagination' => $data['simpanan']] )); ?>
            ...
            <div class="col-auto">
                <div style="border-left:1px solid #dedede;padding:20px 20px;height:100%;width:250px" class="mb-4">
                    <div class="form-group">
                        ...
                        <div class="font-size-13">Rp <?php echo e(number_format($data['saldo']->simpanan_pokok,0,',','.')); ?></div>
                    </div>
                    <div class="form-group">
                        <label>Saldo Simpanan Wajib</label>
                        <div class="font-size-13">Rp <?php echo e(number_format($data['saldo']->simpanan_wajib,0,',','.')); ?></div>
                    </div>
                    <div class="form-group">
                        <label>Saldo Simpanan Sukarela</label>
                        <div class="font-size-13">Rp <?php echo e(number_format($data['saldo']->simpanan_sukarela,0,',','.')); ?></div>
                    </div>
                    <div class="form-group">
                        <label>Saldo Simpanan Hari Raya</label>
                        <div class="font-size-13">Rp <?php echo e(number_format($data['saldo']->simpanan_hari_raya,0,',','.')); ?></div>
                    </div>
                    <div class="form-group">
                        <label>Total Saldo Simpanan</label>
                        <div class="font-size-13">Rp <?php echo e(number_format($data['saldo']->total_simpanan,0,',','.')); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="form-transaksi">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('main/transaksi/proses')); ?>" id="proses_transkasi" method="post">
                    <?php echo e(csrf_field()); ?>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div id="sisa_saldo" style="text-align: right;font-style: italic;color: #a7a7a7;margin-top: 5px;">
                                Sisa Saldo Rp <?php echo e(number_format(\App\Helpers\GlobalHelper::saldo_tabungan(Session::get('useractive')->no_anggota,'Simpanan Sukarela'),0,',','.')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/main/transaksi/simpanan/index.blade.php ENDPATH**/ ?>