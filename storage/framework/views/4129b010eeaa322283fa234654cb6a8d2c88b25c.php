<table class="table table-bordered table-sm">
    ...
    <?php $__currentLoopData = $jurnals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurnal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr>
            ...
            <td class="text-right"><?php echo e(format_number($jurnal->debit)); ?></td>
            <td class="text-right"><?php echo e(format_number($jurnal->kredit)); ?></td>
            <td class="text-right"><?php echo e(format_number($saldo)); ?></td>
        </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
<?php /**PATH /var/www/html/resources/views/keuangan/buku_besar/_table.blade.php ENDPATH**/ ?>