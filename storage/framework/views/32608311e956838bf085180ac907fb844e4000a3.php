  ...
  <div class="row mt-3">
    <div class="col-md-5">
      <div class="card">
        ...
        <div class="card-body">
          <form action="<?php echo e(url('master/kategori_barang/proses')); ?>" method="post" enctype="multipart/form-data">
          ...
          <form action="<?php echo e(url('master/kategori_barang/proses')); ?>" method="post" id="form_hapus">
            <?php echo e(csrf_field()); ?>
...
<?php $__env->startSection('js'); ?>
  <script>
    $(function () {
      ...
      $.get("<?php echo e(url('api/get_tree_kategori')); ?>",function (result) {
        console.log(result);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/master/kategori_barang/index.blade.php ENDPATH**/ ?>