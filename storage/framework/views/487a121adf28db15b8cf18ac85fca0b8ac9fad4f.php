<table class="table table-sm table-bordered">
    ...
    <?php $__currentLoopData = $list_akun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr>
            ...
            <td class="text-right"><?php echo e((substr($value->kode_tampil, 0, 1) == '3' ? (-1 * $value->nominal) : $value->nominal)); ?></td>
        </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <tr class="border-top">
        <td><b>Total Pengeluaran</b></td>
        <td class="text-right"><?php echo e(($pengeluaran)); ?></td>
    </tr>
    <tr>
        <td colspan="2"></td>
    </tr>
    <tr class="border-top">
        <td><b>Laba/rugi</b></td>
        <td class="text-right"><?php echo e(($pendapatan - $pengeluaran)); ?></td>
    </tr>
    </tbody>
</table>
<?php /**PATH /var/www/html/resources/views/keuangan/laba_rugi/export.blade.php ENDPATH**/ ?>