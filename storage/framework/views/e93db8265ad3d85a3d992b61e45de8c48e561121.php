<?php
    $app='pos';
    $page='Laporan';
    $subpage='Laporan Retur Pembelian';
?>
            ...
            <div class="page-title-box">
                <div class="media">
                    ...
                    <div class="media-body align-self-center">
                        <h4 class="mb-0 font-size-18">Data Laporan Retur Pembelian</h4>
                        <p class="text-muted m-0">Menampilkan laporan hasil retur_pembelian</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="select2" style="width:100%" id="fid_supplier" name="fid_supplier">
                            ...
                            <?php $__currentLoopData = $supplier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value->id); ?>"><?php echo e($value->nama_supplier); ?></option>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        let search_data = (page = 1) => {
            ...
            data.page = page;
            $.post("<?php echo e(url('pos/laporan_retur_pembelian/search')); ?>", data, (result) => {
                $table.html(result);
            }).fail((xhr) => {
        ...
        let export_Excel = () => {
            ...
            window.open("<?php echo e(url('pos/laporan_retur_pembelian/excel')); ?>?" + data, '_blank');
        }

        let cetak = () => {
            let data = $form_search.serialize();
            window.open("<?php echo e(url('pos/laporan_retur_pembelian/cetak')); ?>?" + data, '_blank');
        }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pos/laporan/retur_pembelian/index.blade.php ENDPATH**/ ?>