...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid">
    ...
    <form action="<?php echo e(url('simpanan/sukarela/proses')); ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <?php else: ?>
            <h5><?php echo e(($action=='add' ? 'Tambah' : 'Edit')); ?> Setoran Simpanan Sukarela</h5>
          <?php endif; ?>
        </div>
        <div class="card-body">
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <div class="list-content">
                      ...
                      <div id="no_anggota" class="info-content"><?php echo (!empty($data['simpanan']) ? $data['simpanan']->no_anggota :'<hr>'); ?></div>
                    </div>
                    <div class="list-content">
                      <span>Nama Lengkap</span>
                      <div id="nama_lengkap" class="info-content"><?php echo (!empty($data['simpanan']) ? $data['simpanan']->nama_lengkap :'<hr>'); ?></div>
                    </div>
                  </div>
                </div>
                <input type="hidden" name="no_anggota" value="<?php echo e((!empty($data['simpanan']) ? $data['simpanan']->no_anggota : '')); ?>" id="fid_anggota">
              ...
              <div class="row">
                <div class="col-md-2">
                  <div class="form-group">
                    <label>Tanggal</label>
                    <input type="text" name="tanggal" autocomplete="off" value="<?php echo e((!empty($data['simpanan']) ? \App\Helpers\GlobalHelper::dateFormat($data['simpanan']->tanggal,'d-m-Y') : date('d-m-Y'))); ?>" class="datepicker form-control">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="jenis_simpanan" class="form-control select2">
                      <?php $__currentLoopData = $data['jenis_simpanan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->id); ?>" <?php echo e((!empty($data['simpanan']) && $data['simpanan']->fid_jenis_transaksi==$value->id ? 'selected' : '')); ?> ><?php echo e($value->jenis_transaksi); ?></option>
                  ...
                  <div class="form-group">
                    ...
                    <select name="metode_transaksi" class="form-control select2">
                      <?php $__currentLoopData = $data['metode-transaksi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->id); ?>" <?php echo e((!empty($data['simpanan']) && $data['simpanan']->fid_metode_transaksi==$value->id ? 'selected' : '')); ?> ><?php echo e($value->keterangan); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" style="text-align:right" class="form-control autonumeric" data-a-dec="." data-a-sep="," name="nominal" value="<?php echo e((!empty($data['simpanan']) ? $data['simpanan']->nominal : '0')); ?>"  >
        ...
        <div class="card-footer">
          ...
          <div class="pull-right">
            <a class="btn btn-secondary" href="<?php echo e(url('simpanan/sukarela')); ?>" >Kembali</a>
            <?php if(!empty($data['simpanan']) && $data['simpanan']->fid_status == 2 ): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simpanan/sukarela/form.blade.php ENDPATH**/ ?>