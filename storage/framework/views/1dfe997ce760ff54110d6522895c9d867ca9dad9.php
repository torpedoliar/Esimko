    ...
    <div class="container-fluid">
        <div class="content-breadcrumb mb-2">
            ...
            <div class="row">
                ...
                <div class="col-lg-1">
                    <a href="<?php echo e(url('monitoring/saldo_simpanan/detail')); ?>" class="btn btn-block btn-success">Detail</a>
                </div>
                <div class="col-lg-1">
        ...
        <?php if($data['saldo']==null || count($data['saldo']) == 0): ?>
        ...
        <?php else: ?>
            <div class="table-responsive mt-4 mb-4">
                <table class="table table-middle table-custom">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $data['saldo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr onclick="window.location.href = '<?php echo e(url('monitoring/saldo_simpanan/detail?no_anggota=' . $value->no_anggota)); ?>'">
                            <td style="border-color:<?php echo e($value->color); ?>">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <h5 class="text-truncate font-size-15"><span class="text-dark"><?php echo e($value->nama_lengkap); ?></span></h5>
                                    </div>
                                </div>
                            </td>
                            <td style="text-align:right">Rp <?php echo e(number_format($value->simpanan_pokok,'0',',','.')); ?></td>
                            <td style="text-align:right">Rp <?php echo e(number_format($value->simpanan_wajib,'0',',','.')); ?></td>
                            <td style="text-align:right">Rp <?php echo e(number_format($value->simpanan_sukarela,'0',',','.')); ?></td>
                            <td style="text-align:right">Rp <?php echo e(number_format($value->simpanan_hari_raya,'0',',','.')); ?></td>
                            <td style="text-align:right">Rp <?php echo e(number_format($value->total_simpanan,'0',',','.')); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
            ...
            <div class="mb-4 mt-3">
                <?php echo e($data['saldo']->links('include.pagination', ['pagination' => $data['saldo']] )); ?>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        cetak = () => {
            window.open("<?php echo e(url('monitoring/saldo_simpanan/cetak')); ?>", '_blank');
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/monitoring/saldo_simpanan.blade.php ENDPATH**/ ?>