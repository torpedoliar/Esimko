    ...
    <div class="container-fluid">
        <div class="content-breadcrumb mb-2">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a class="btn btn-primary btn-block" href="<?php echo e(url('manajemen_stok/barang/form')); ?>">Tambah Barang</a>
                </div>
            </div>
        </div>
                ...
                <table class="table table-middle table-custom">
                    ...
                    <?php $__currentLoopData = $data['produk']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <div class="media">
                                    ...
                                    <div class="align-self-center media-body">
                                        <span>Kode. <?php echo e($value->kode); ?> | <b><?php echo e($value->id); ?></b></span>
                            ...
                            <td class="center"><?php echo e($value->stok_masuk); ?><br><?php echo e($value->satuan); ?></td>
                            <td class="center"><?php echo e($value->stok_keluar); ?><br><?php echo e($value->satuan); ?></td>
                            <td class="center"><?php echo e($value->penyesuaian ?? ''); ?><br><?php echo e($value->satuan); ?></td>
                            <td class="center"><?php echo e($value->sisa); ?><br><?php echo e($value->satuan); ?></td>
                            ...
                            <td style="width:1px;white-space:nowrap">
                                <a href="<?php echo e(url('manajemen_stok/barang/detail?id='.$value->id)); ?>" class="text-dark"><i class="bx bx-search-alt h3 m-0"></i></a>
                                <a href="<?php echo e(url('manajemen_stok/barang/form?page='.$request->page.'&id='.$value->id)); ?>" class="text-dark"><i class="bx bx-edit h3 m-0"></i></a>
                                <a href="javascript:;" onclick="confirmDelete(<?php echo e($value->id); ?>)" class="text-dark"><i class="bx bx-trash h3 m-0"></i></a>
                                <form action="<?php echo e(url('manajemen_stok/barang/proses')); ?>" method="post" id="hapus<?php echo e($value->id); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/manajemen_stok/barang/index.blade.php ENDPATH**/ ?>