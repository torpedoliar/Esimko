...
<body>
    <div class="header">
        <div class="logo">
            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" onerror="this.style.display='none'">
            <div>
                <h1>eSIMKO</h1>
    ...
    <div class="main-content">
        <div class="items-section">
            <?php if(!$penjualan || count($items) == 0): ?>
                <div class="no-items">
            ...
            <?php else: ?>
                ...
                <div class="items-list" id="items-list">
                    ...
                    <div class="item-row">
                        <div class="col-name">
                            <h3><?php echo e($item->produk->nama_produk ?? $item->nama_barang ?? 'Produk'); ?></h3>
                            <small><?php echo e($item->produk->kode_produk ?? ''); ?></small>
                        </div>
                        <div class="col-qty"><?php echo e($item->jumlah); ?></div>
                        <div class="col-price">Rp <?php echo e(number_format($item->harga ?? 0, 0, ',', '.')); ?></div>
                        <div class="col-subtotal">Rp <?php echo e(number_format($item->total ?? 0, 0, ',', '.')); ?></div>
                    </div>
        ...
        <div class="summary-section">
            <div class="summary-item">
                ...
                <span class="value"><?php echo e(count($items)); ?></span>
            </div>
            <div class="summary-item">
                <span class="label">Diskon</span>
                <span class="value">Rp <?php echo e(number_format($penjualan->diskon ?? 0, 0, ',', '.')); ?></span>
            </div>
            <div class="summary-item total">
                ...
                ?>
                <span class="value">Rp <?php echo e(number_format($displayTotal, 0, ',', '.')); ?></span>
            </div>
            
            <?php if($penjualan && $penjualan->anggota): ?>
            <div class="customer-name">
                <small>Pelanggan</small>
                <h2><?php echo e($penjualan->anggota->nama_lengkap); ?></h2>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        ...
        function checkAndSync() {
            ...
            if (storedId && storedId !== currentId && storedId !== 'customer_display') {
                window.location.href = '<?php echo e(url("pos/customer_display")); ?>/' + storedId;
                return;
            }
...
<?php /**PATH /var/www/html/resources/views/pos/penjualan_baru/customer_display.blade.php ENDPATH**/ ?>