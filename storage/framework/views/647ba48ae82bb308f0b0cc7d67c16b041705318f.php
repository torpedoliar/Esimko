...
<div class="container-fluid">
  ...
  <form action="<?php echo e(url('penarikan/penutupan/proses')); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="card">
              ...
              <div class="row">
                <div class="col-auto">
                  <div class="avatar-wrapper" id="avatar" style="height:100px;width:100px">
                    <img src="<?php echo e((!empty($data['penarikan']->avatar) ? asset('storage/'.$data['penarikan']->avatar) : asset('assets/images/user-avatar-placeholder.png') )); ?>">
                  </div>
                </div>
                <div class="col">
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <div class="form-group">
                  ...
                  <input type="text" name="jumlah" id="nominal" style="text-align:right" class="form-control autonumeric" data-a-dec="." data-a-sep="," value="<?php echo e((!empty($data['penarikan']) ? str_replace('-','',$data['penarikan']->nominal) : 0 )); ?>" readonly >
                </div>
              </div>
            </div>
            <div class="form-group">
              <label>Keterangan</label>
              <textarea name="keterangan" class="form-control" style="height:110px"><?php echo e((!empty($data['penarikan']) ? $data['penarikan']->keterangan : '' )); ?></textarea>
            </div>
      ...
      <div class="card-footer">
        ...
        <div class="pull-right">
          <a class="btn btn-secondary" href="<?php echo e(url('penarikan/penutupan')); ?>" >Kembali</a>
          <button class="btn btn-primary" id="action" type="submit"><?php echo e(($action=='add' ? 'Tambah' : 'Simpan')); ?></button>
        </div>
      </div>
    </div>
  </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/penarikan/penutupan/form.blade.php ENDPATH**/ ?>