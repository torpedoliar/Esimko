<div class="table-responsive mt-4 mb-4">
    <table class="table table-middle table-custom">
        ...
        <tr>
            ...
            <td style="text-align:right"><b><?php echo e(format_number($retur_pembelian->sum('total'))); ?></b></td>
            <td></td>
        </tr>
        </tbody>
    </table>
</div>
<?php echo e($retur_pembelian->links('include.custom', ['function' => 'search_data'])); ?>

<?php /**PATH /var/www/html/resources/views/pos/laporan/retur_pembelian/_table.blade.php ENDPATH**/ ?>