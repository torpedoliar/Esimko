  ...
  <div class="row mt-4 mb-4">
    <div class="col-md-9">
      <div class="card">
        <div class="card-body">
          ...
          <hr>
          <form action="<?php echo e(url('transaksi/proses')); ?>" id="proses_transkasi" method="post">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="jenis_transaksi" onchange="calc_angsuran()" id="jenis_pinjaman" class="form-control select2">
                    ...
                    <option value="<?php echo e($value->id); ?>"  ><?php echo e($value->jenis_transaksi); ?></option>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" style="text-align:right" onkeyup="calc_angsuran()" id="gaji_pokok" class="form-control autonumeric" data-a-dec="," data-a-sep="." name="gaji_pokok" value="<?php echo e($data['gaji-pokok'][1]); ?>">
            ...
            <input type="hidden" name="bulan" value="<?php echo e($data['gaji-pokok'][0]); ?>">
    ...
    <div class="col-md-3">
      ...
      <div class="list-content">
        ...
        <div class="info-content">Rp <?php echo e(number_format($data['setoran-berkala'],0,',','.')); ?></div>
      </div>
      <?php $__currentLoopData = $data['jenis-transaksi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="list-content">
          <span>Angsuran <?php echo e($value->jenis_transaksi); ?></span>
          <div class="info-content">Rp <?php echo e(number_format($value->angsuran,0,',','.')); ?></div>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <div class="list-content">
        <span>Total Angsuran Belanja</span>
        <div class="info-content">Rp <?php echo e(number_format($data['angsuran-belanja'],0,',','.')); ?></div>
      </div>
      <div class="list-content">
        <span>Total Angsuran</span>
        <div class="info-content"><?php echo e(number_format($data['total-angsuran'],0,',','.')); ?></div>
...
<?php $__env->startSection('js'); ?>
  ...
  function calc_angsuran(){
    ...
    total_angsuran=<?php echo e($data['total-angsuran']); ?>;
    ...
    total_angsuran_pinjaman=<?php echo e($data['angsuran-pinjaman']); ?>+<?php echo e($data['angsuran-simpanan']); ?>+angsuran_pinjaman;

    $.get("<?php echo e(url('api/check_sisa_pinjaman/'.Session::get('useractive')->no_anggota)); ?>/"+jenis,function (result) {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/main/transaksi/pinjaman/form.blade.php ENDPATH**/ ?>