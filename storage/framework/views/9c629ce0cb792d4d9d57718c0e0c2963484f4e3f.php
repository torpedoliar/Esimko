...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <form action="<?php echo e(url('pos/belanja/'.$jenis.'/proses')); ?>" method="post" id="proses">
                ...
                <div class="coloum-left" style="position:relative">
                    <div style="padding:20px">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="text" id="tanggal" value="<?php echo e((!empty($data['belanja']) ? \App\Helpers\GlobalHelper::dateFormat($data['belanja']->tanggal,'d-m-Y') : date('d-m-Y'))); ?>" class="form-control datepicker" name="tanggal" autocomplete="off" name="tanggal" >
                            </div>
                            <div class="col-md-3">
                                <input type="text" value="<?php echo e((!empty($data['belanja']) ? $data['belanja']->no_transaksi : '')); ?>" class="form-control" placeholder="No. Transaksi" autocomplete="off" name="no_transaksi" <?php echo e(($jenis=='konsinyasi' ? 'readonly' : '')); ?> >
                            </div>
                            <?php if($jenis=='online'): ?>
                                <div class="col-md-3">
                                    <input type="text" value="<?php echo e((!empty($data['belanja']) ? $data['belanja']->marketplace : '')); ?>" class="form-control" placeholder="Platform Marketplace" autocomplete="off" name="marketplace" >
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <table class="table table-middle table-hover">
                            ...
                            <?php $__currentLoopData = $data['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="text-align:right;white-space:nowrap">Rp <?php echo e(number_format(($value->harga_beli ?? 0),0,',','.')); ?></td>
                                    <td style="text-align:center;white-space:nowrap"><?php echo e($value->margin); ?>%</td>
                                    <td style="text-align:right;white-space:nowrap">Rp <?php echo e(number_format($value->harga,0,',','.')); ?></td>
                                    <td style="text-align:right;white-space:nowrap">Rp <?php echo e(number_format($value->total,0,',','.')); ?></td>
                                    <td style="width:1px;white-space:nowrap">
                                        <div class="text-center">
                                            <a href="javascript:;" onclick="edit_barang(<?php echo e($value->id); ?>)" class="text-dark"><i class="bx bx-edit h3 m-0"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group mb-0">
                                    <label>Total</label>
                                    <input type="text" class="form-control autonumeric" name="total_pembayaran" id="total_pembayaran" readonly style="text-align:right" value="<?php echo e((!empty($data['belanja']) ? $data['belanja']->total_pembayaran : 0 )); ?>" data-a-dec="," data-a-sep=".">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group mb-0">
                                    <label>Tenor</label>
                                    <input type="text" style="text-align:center" data-toggle="touchspin" value="<?php echo e((!empty($data['belanja']->tenor) ? $data['belanja']->tenor : 1)); ?>" class="form-control" name="tenor" id="tenor" onchange="calc_belanja()" >
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group mb-0">
                                    <label>Angsuran</label>
                                    <input type="text" style="text-align:right" value="<?php echo e((!empty($data['belanja']) ? $data['belanja']->angsuran : '')); ?>" class="form-control autonumeric" data-a-dec="," data-a-sep="." name="angsuran" id="angsuran" readonly >
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="coloum-right" style="position:relative;">
                    <div style="padding:20px;height:calc(100vh - 300px);margin-bottom:20px;overflow:scroll;">
                        <div class="media" style="cursor:pointer;" onclick="pilih_anggota('show')" >
                            <div class="avatar-thumbnail avatar-sm rounded-circle mr-2" id="avatar" style="height:60px;width:60px">
                                <img src="<?php echo e((!empty($data['setoran-berkala']->avatar) ? asset('storage/'.$data['setoran-berkala']->avatar) : asset('assets/images/user-avatar-placeholder.png') )); ?>" alt="" class="rounded-circle" />
                            </div>
                            <div class="align-self-center media-body">
                                <div id="no_anggota" >
                                    <?php if(!empty($data['belanja']->no_anggota)): ?>
                                        <span>No. <?php echo e($data['belanja']->no_anggota); ?></span>
                                    <?php else: ?>
                                        <div style="height:15px;width:80%;background:whitesmoke"></div>
                                    <?php endif; ?>
                                </div>
                                <div id="nama_lengkap">
                                    <?php if(!empty($data['belanja']->nama_lengkap)): ?>
                                        <h5><?php echo e($data['belanja']->nama_lengkap); ?></h5>
                                    <?php else: ?>
                    ...
                    <?php if($action=='edit'): ?>
                        <div style="width:100%;position:absolute;bottom:0px;padding:20px">
                            <?php if($data['belanja']->fid_status==3): ?>
                                <div class="row gutter-2">
                                    <div class="col-md-6">
                                        <a href="<?php echo e(url('pos/penjualan')); ?>" class="btn btn-dark btn-block">Kembali</a>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(url('pos/belanja/konsinyasi')); ?>" class="btn btn-dark btn-block mt-2">Kembali</a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <input type="hidden" name="fid_anggota" value="<?php echo e((!empty($data['belanja']->no_anggota) ? $data['belanja']->no_anggota : null)); ?>" id="fid_anggota">
            <input type="hidden" id="anggota_id" value="<?php echo e((!empty($data['belanja']) ? $data['belanja']->anggota_id : '')); ?>" >
        </form>
    </div>
    <?php $__currentLoopData = $data['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form action="<?php echo e(url('pos/belanja/'.$jenis.'/items/proses')); ?>" method="post" id="hapus<?php echo e($value->id); ?>">
            <?php echo e(csrf_field()); ?>

            <input type="hidden" name="id" value="<?php echo e($value->id); ?>">
        </form>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <form action="<?php echo e(url('pos/belanja/'.$jenis.'/proses_pembatalan')); ?>" method="post" id="proses_pembatalan">
        <?php echo e(csrf_field()); ?>
    ...
    <div class="modal fade" id="form-barang">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('pos/belanja/'.$jenis.'/items/proses')); ?>" method="post" id="form_belanja">
                    <?php echo e(csrf_field()); ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="penjualan_id" value="<?php echo e($id); ?>">
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        <?php if(!empty($data['belanja'])): ?>
        pilih_anggota('<?php echo e($data['belanja']->anggota_id); ?>');
        <?php endif; ?>
        ...
        $("#tanggal").change(function(){
            ...
            if(anggota_id != 0 ){
                $.get("<?php echo e(url('api/find_anggota')); ?>/"+anggota_id+"/"+bulan_sekarang,function(result){
                    $('#gaji_pokok').val(accounting.formatNumber(result.gaji_pokok,0,'.',','));
                    $('#bulan').val(result.bulan);
                    $('#bulan_gaji').html('Bulan '+result.bulan_tampil);
                });
        ...
        function calc_belanja(){
            ...
            //         color='danger';
            //         note='Belum bisa melakukan pengajuan belanja <?php echo e($jenis); ?> dengan total angsuran Rp '+accounting.formatNumber(angsuran,0,'.',',')+', karena angsuran kredit belanja melebihi limit Rp 1.500.000';
            //         $("#action").prop('disabled', false);
            //       }
            //       else{
            //         color='success';
            //         note='Silahkan melakukan pengajuan belanja <?php echo e($jenis); ?> dengan total angsuran Rp '+accounting.formatNumber(angsuran,0,'.',',');
            //         $("#action").prop('disabled', false);
            //       }
            //     }
            //     else{
            //       color='danger';
            //       note='Belum bisa melakukan pengajuan kredit belanja <?php echo e($jenis); ?> dengan total angsuran Rp '+accounting.formatNumber(angsuran,0,'.',',')+' karena total angsuran melebihi Gaji Pokok. Silahkan masukkan jumlah kredit dan tenor yang sesuai atau ubah kembali nominal setoran berkala';
        ...
        function edit_barang(id){
            $.get("<?php echo e(url('api/find_items_penjualan')); ?>/"+id,function(result){
...
<?php echo $__env->make('layouts.kasir', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pos/belanja/form.blade.php ENDPATH**/ ?>