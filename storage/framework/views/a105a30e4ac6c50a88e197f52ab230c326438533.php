...
<div class="container-fluid">
  ...
  <form action="<?php echo e(url('master/karyawan/proses')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>

    <div class="card">
      <div class="card-header">
        <h5><?php echo e(($action=='add' ? 'Tambah' : 'Edit')); ?> Data Karyawan</h5>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-5">
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="list-content">
                    ...
                    <div id="no_anggota" class="info-content"><?php echo (!empty($data['karyawan']) ? $data['karyawan']->no_anggota :'<hr>'); ?></div>
                  </div>
                  <div class="list-content">
                    <span>Nama Lengkap</span>
                    <div id="nama_lengkap" class="info-content"><?php echo (!empty($data['karyawan']) ? $data['karyawan']->nama_lengkap :'<hr>'); ?></div>
                  </div>
                </div>
              </div>
              <input type="hidden" name="no_anggota" value="<?php echo e((!empty($data['karyawan']) ? $data['karyawan']->no_anggota : '')); ?>" id="fid_anggota">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="tanggal" autocomplete="off" value="<?php echo e((!empty($data['karyawan']) ? \App\Helpers\GlobalHelper::dateFormat($data['karyawan']->tanggal,'d-m-Y') : date('d-m-Y'))); ?>" class="datepicker form-control">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>Jabatan</label>
                  <input type="text" class="form-control" name="jabatan" value="<?php echo e((!empty($data['karyawan']) ? $data['karyawan']->jabatan : null)); ?>"  >
                </div>
              </div>
            </div>
      ...
      <div class="card-footer">
        ...
        <div class="pull-right">
          <a class="btn btn-secondary" href="<?php echo e(url('master/karyawan')); ?>" >Kembali</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/master/karyawan/form.blade.php ENDPATH**/ ?>