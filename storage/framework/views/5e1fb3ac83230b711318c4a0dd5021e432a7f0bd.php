...
<div class="container-fluid">
  <div class="content-breadcrumb mb-2">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <a class="btn btn-primary btn-block" href="<?php echo e(url('penarikan/penutupan/form')); ?>">Formulir Penarikan</a>
      </div>
    </div>
  </div>
    ...
    <table class="table table-middle table-custom">
      ...
      <tbody>
        <?php $__currentLoopData = $data['penarikan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td class="center" style="border-color:<?php echo e($value->color); ?>"><?php echo e(\App\Helpers\GlobalHelper::dateFormat($value->tanggal,'d/m/Y')); ?></td>
            <td>
              <div class="media">
            ...
            <td style="width:1px;white-space:nowrap">
              <div class="text-center">
                <a href="<?php echo e(url('penarikan/penutupan/detail?id='.$value->id)); ?>" class="text-dark"><i class="bx bx-search h3 m-0"></i></a>
              </div>
            </td>
          </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/penarikan/penutupan/index.blade.php ENDPATH**/ ?>