...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid">
    ...
    <form action="<?php echo e(url('pinjaman/pengajuan/proses')); ?>" method="post" enctype="multipart/form-data">
      <?php echo e(csrf_field()); ?>

      <div class="card">
        <div class="card-header">
          <h5>Formulir <?php echo e($data['jenis-pinjaman']->jenis_transaksi); ?></h5>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-5">
              <div style="border:#dfe4e9 dashed 2px ;padding:20px">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <div class="list-content">
                      ...
                      <div id="no_anggota" class="info-content"><?php echo (!empty($data['pinjaman']) ? $data['pinjaman']->no_anggota :'<hr>'); ?></div>
                    </div>
                    <div class="list-content">
                      <span>Nama Lengkap</span>
                      <div id="nama_lengkap" class="info-content"><?php echo (!empty($data['pinjaman']) ? $data['pinjaman']->nama_lengkap :'<hr>'); ?></div>
                    </div>
                  </div>
                </div>
                ...
                <input type="hidden" name="no_anggota" value="<?php echo e((!empty($data['pinjaman']) ? $data['pinjaman']->no_anggota : '')); ?>" id="fid_anggota">
            ...
            <div class="col-md-7">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Tanggal</label>
                    <input type="text" id="tanggal" name="tanggal" autocomplete="off" value="<?php echo e((!empty($data['pinjaman']) ? \App\Helpers\GlobalHelper::dateFormat($data['pinjaman']->tanggal,'d-m-Y') : date('d-m-Y') )); ?>" class="datepicker form-control">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="metode_transaksi" class="form-control select2">
                      <?php $__currentLoopData = $data['metode-transaksi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->id); ?>" <?php echo e((!empty($data['pinjaman']) && $data['pinjaman']->fid_metode_transaksi==$value->id ? 'selected' : '')); ?> ><?php echo e($value->keterangan); ?></option>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" onkeyup="calc_angsuran()" id="jumlah_pinjaman" style="text-align:right" class="form-control autonumeric" data-a-dec="," data-a-sep="."  name="nominal" value="<?php echo e((!empty($data['pinjaman']) ? str_replace('-','',$data['pinjaman']->nominal) : '0')); ?>"  >
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="control-label">Tenor</label>
                    <input data-toggle="touchspin" onchange="calc_angsuran()" id="tenor" name="tenor" value="<?php echo e((!empty($data['pinjaman']) ? $data['pinjaman']->tenor : '1')); ?>" type="text" value="0" data-max="60">
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="form-group">
                ...
                <textarea name="keterangan" class="form-control" style="height:150px"><?php echo e((!empty($data['pinjaman']) ? $data['pinjaman']->keterangan : '')); ?></textarea>
              </div>
              <div id="alert"></div>
            </div>
          </div>
        ...
        <div class="card-footer">
          ...
          <input type="hidden" name="jenis" value="<?php echo e($data['jenis-pinjaman']->id); ?>">
          <div class="pull-right">
            <a class="btn btn-secondary" href="<?php echo e(url('pinjaman/pengajuan')); ?>" >Kembali</a>
            <button class="btn btn-primary" type="submit" name="action" id="action" value="<?php echo e($action); ?>">Simpan</button>
          </div>
        </div>
      </div>
    </form>
...
<?php $__env->startSection('js'); ?>
  ...
  <script>
    ...
    function calc_angsuran(){
      ...
      if(anggota_id != 0 ){
        $.get("<?php echo e(url('api/find_anggota')); ?>/"+anggota_id+"/"+bulan_sekarang,function(result){
          ...
          $.get("<?php echo e(url('api/check_sisa_pinjaman')); ?>/"+result.no_anggota+"/<?php echo e($data['jenis-pinjaman']->id); ?>",function (result2){
    ...
    <?php if(!empty($data['pinjaman'])): ?>
    pilih_anggota('<?php echo e($data['pinjaman']->anggota_id); ?>');
    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pinjaman/pengajuan/form.blade.php ENDPATH**/ ?>