...
<div class="container-fluid">
  <div class="content-breadcrumb mb-2">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <a href="<?php echo e(url('simpanan/sukarela/form')); ?>" class="btn btn-primary btn-block">Formulir Setoran</a>
      </div>
    </div>
  </div>
  <?php if(count($data['simpanan-sukarela'])==0): ?>
  ...
  <div class="table-responsive mt-4 mb-4">
    <table class="table table-middle table-custom">
      ...
      <tbody>
        <?php $__currentLoopData = $data['simpanan-sukarela']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td style="width:1px;white-space:nowrap">
              <div class="text-center">
                <a href="<?php echo e(url('simpanan/sukarela/detail?id='.$value->id)); ?>" class="text-dark"><i class="bx bx-search h3 m-0"></i></a>
                <?php if(trim(str_replace(PHP_EOL, '', $value->keterangan)) == '-'): ?>
                  <a href="javascript:vod(0)" onclick="delete_simpanan(<?php echo e($value->id); ?>)" class="text-dark"><i class="bx bx-trash h3 m-0"></i></a>
                <?php endif; ?>
              </div>
            </td>
          </tr>
  ...
  <div class="mb-3">
    <?php echo e($data['simpanan-sukarela']->links('include.pagination', ['pagination' => $data['simpanan-sukarela']] )); ?>
  ...
  delete_simpanan = (id) => {
    Swal.fire({
      ...
      if (result.value == true) {
        window.location.href = "<?php echo e(url('simpanan/sukarela/delete')); ?>?id=" + id;
      }
    });
  }
  </script>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simpanan/sukarela/index.blade.php ENDPATH**/ ?>