...
<div class="container-fluid">
  ...
  <?php if(Session::has('message')): ?>
    <div class="alert alert-<?php echo e(Session::get('message_type')); ?> alert-dismissible fade show" role="alert">
  ...
  <div class="row">
    ...
    <div class="col-md-5">
      <div class="card">
        ...
        <div class="card-body">
          <form action="<?php echo e(url('pengaturan/bunga_pinjaman/proses')); ?>" method="POST" id="formBunga">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" step="0.01" min="0" max="100" name="nilai" id="inputBunga"
                       value="<?php echo e(($data['pengaturan']->nilai ?? 0.01) * 100); ?>" 
            ...
            <div class="card bg-light mb-3">
              <div class="card-body">
                ...
                <p class="mb-1">Jika pinjaman <strong>Rp 10.000.000</strong> dengan bunga <strong id="previewPersen"><?php echo e(($data['pengaturan']->nilai ?? 0.01) * 100); ?>%</strong>:</p>
                <p class="mb-0">Bunga per bulan = <strong id="previewBunga">Rp <?php echo e(number_format(10000000 * ($data['pengaturan']->nilai ?? 0.01), 0, ',', '.')); ?></strong></p>
              </div>
            </div>
        ...
        <div class="card-body p-0">
          <div class="table-responsive">
            <table class="table table-striped table-hover mb-0">
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $data['logs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                  <td><?php echo e(\App\Helpers\GlobalHelper::tgl_indo($log->created_at)); ?></td>
                  <td><span class="badge badge-secondary"><?php echo e($log->nilai_lama * 100); ?>%</span></td>
                  <td><span class="badge badge-primary"><?php echo e($log->nilai_baru * 100); ?>%</span></td>
                  <td><?php echo e($log->nama_admin); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pengaturan/bunga_pinjaman/index.blade.php ENDPATH**/ ?>