...
<html lang="en">
  <head>
    ...
    .signin-wrapper .content-left{
      /* background-image:url('<?php echo e(asset('assets/images/bg-top.png')); ?>'),url('<?php echo e(asset('assets/images/bg-bottom.png')); ?>');
      ...
      <div class="content-left">
        <div class="inner center d-flex flex-column justify-content-center">
          <div style="text-align:center">
            <img src="<?php echo e(asset('assets/images/logo-login.png')); ?>" style="width:350px">
          </div>
        </div>
      </div>
