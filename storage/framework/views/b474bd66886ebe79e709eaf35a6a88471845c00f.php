        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="select2" style="width:100%" name="satuan">
                    <?php $__currentLoopData = $satuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    $form_produk_baru.submit((e) => {
        ...
        $.post("<?php echo e(url('manajemen_stok/pembelian_baru/item/produk_baru')); ?>", data, (result) => {
            console.log(result);
...
<?php /**PATH /var/www/html/resources/views/pos/pembelian_baru/_produk_baru.blade.php ENDPATH**/ ?>