...
@section('js')
    <script>
        ...
        let search_data = (page = 1) => {
            ...
            data.page = page;
            $.post("{{ url('pos/laporan_retur_pembelian/search') }}", data, (result) => {
                $table.html(result);
            }).fail((xhr) => {
        ...
        let export_Excel = () => {
            ...
            window.open("{{ url('pos/laporan_retur_pembelian/excel') }}?" + data, '_blank');
        }

        let cetak = () => {
            let data = $form_search.serialize();
            window.open("{{ url('pos/laporan_retur_pembelian/cetak') }}?" + data, '_blank');
        }
