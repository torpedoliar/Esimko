...
@section('js')
    <script>
        ...
        let search_data = (page = 1) => {
            ...
            data.page = page;
            $table.html('Loading ... ');
            $.post("{{ url('pos/laporan_penjualan/search') }}", data, (result) => {
                $table.html(result);
            }).fail((xhr) => {
        ...
        let export_Excel = () => {
            ...
            window.open("{{ url('pos/laporan_penjualan/excel') }}?" + data, '_blank');
        }

        let cetak = () => {
            let data = $form_search.serialize();
            window.open("{{ url('pos/laporan_penjualan/cetak') }}?" + data, '_blank');
        }
