...
<div class="container-fluid">
  <div class="content-breadcrumb mb-2">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <a href="{{url('penarikan/sukarela/form')}}" class="btn btn-primary btn-block">Formulir Penarikan</a>
      </div>
    </div>
  </div>
          ...
          <tr>
            ...
            <td style="width:1px;white-space:nowrap">
              <div class="text-center">
                <a href="{{url('penarikan/sukarela/detail?id='.$value->id)}}" class="text-dark"><i class="bx bx-search h3 m-0"></i></a>
              </div>
            </td>
          </tr>
        @endforeach
