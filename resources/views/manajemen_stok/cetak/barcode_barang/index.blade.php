  ...
  <div class="container-fluid">
    <div class="content-breadcrumb mb-2">
      <div class="page-title-box">
        <div class="media">
          <img src="{{asset('assets/images/icon-page/qr.png')}}" class="avatar-md mr-3">
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <a class="btn btn-primary btn-block" href="{{url('manajemen_stok/cetak/barcode_barang?mode=cetak')}}" >Cetak Barcode</a>
        </div>
      </div>
    </div>
          ...
          <tr>
            ...
            <td style="width:1px;white-space:nowrap">
              <div class="text-center">
                ...
                <form action="{{url('manajemen_stok/cetak/barcode_barang/proses')}}" method="post" id="hapus{{$value->id}}">
                  {{ csrf_field()}}
  ...
  <div id="filter-barang" class="modal fade">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <form action="{{url('manajemen_stok/cetak/barcode_barang/filter')}}" method="post">
          {{ csrf_field() }}
...
function edit_jumlah(id){
  ...
  $.ajax({
    url:'{{url('manajemen_stok/cetak/barcode_barang/proses')}}',
    method:'POST',
    data:{
      _token: "{{ csrf_token() }}",
      id: id,
...
selected_kelompok = '{{(!empty(Session::get('filter_barcode_barang')) && Session::get('filter_barcode_barang')['kelompok'] !='all'  ? Session::get('filter_barcode_barang')['kelompok'] : 'all')}}';
selected_kategori = '{{(!empty(Session::get('filter_barcode_barang')) && Session::get('filter_barcode_barang')['kategori'] !='all' ? Session::get('filter_barcode_barang')['kategori'] : 'all')}}';
selected_subkategori = '{{(!empty(Session::get('filter_barcode_barang')) && Session::get('filter_barcode_barang')['sub_kategori'] !='all' ? Session::get('filter_barcode_barang')['sub_kategori'] : 'all')}}';
