...
<div class="container-fluid">
  <div class="content-breadcrumb mb-2" style="padding-bottom:10px">
    ...
    <ul class="nav nav-pills mb-2 mt-5">
      ...
      <li class="nav-item waves-effect waves-light pr-2">
        <a class="nav-link {{($tab=='stok_masuk' ? 'active' : '')}}" href="{{url('manajemen_stok/barang/detail?id='.$data['produk']->id.'&tab=stok_masuk')}}">Stok Masuk</a>
      </li>
      <li class="nav-item waves-effect waves-light pr-2">
        <a class="nav-link {{($tab=='stok_keluar' ? 'active' : '')}}" href="{{url('manajemen_stok/barang/detail?id='.$data['produk']->id.'&tab=stok_keluar')}}">Stok Keluar</a>
      </li>
    </ul>
  </div>
