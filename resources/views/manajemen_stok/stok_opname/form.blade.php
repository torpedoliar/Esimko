                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input data-toggle="touchspin" type="text" class="form-control center" name="stok_awal" value="{{(!empty($data['produk']) ? $data['produk']->stok_awal : 1)}}" required >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Stok Minimal</label>
                                        <input data-toggle="touchspin" type="text" class="form-control center" name="stok_minimal" value="{{(!empty($data['produk']) ? $data['produk']->stok_minimal : 1)}}" required >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
