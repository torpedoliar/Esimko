        ...
        <div class="content-breadcrumb mb-2">
            ...
            <form id="form_search">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a class="btn btn-primary btn-block" href="{{url('manajemen_stok/stok_opname/create')}}">Tambah</a>
                    </div>
                </div>
            </form>
            <div id="table"></div>
...
@section('js')
    <script>
        ...
        let search_data = (page = 1) => {
            ...
            data.paginate = 10;
            data.page = page;
            $.post("{{ url('manajemen_stok/stok_opname/search') }}", data, (result) => {
                $table.html(result);
            }).fail((xhr) => {
