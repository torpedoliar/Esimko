            ...
            <tr>
              ...
              <td style="width:1px;white-space:nowrap">
                <div class="text-center">
                  <a href="{{url('anggota/detail?anggota='.$data['anggota']->no_anggota.'&tab='.$tab.'&id='.$value->id)}}" class="text-dark"><i class="bx bx-search-alt h3 m-0"></i></a>
                </div>
              </td>
            </tr>
          @endforeach
  ...
  <div class="col-md-3">
    <div class="mb-4 pt-4">
      <div class="form-group">
        ...
        <div class="font-size-15">Rp {{number_format($data['anggota']->simpanan_pokok,0,',','.')}}</div>
      </div>
      <div class="form-group">
        <p class="text-muted text-truncate mb-2">Saldo Simpanan Wajib</p>
        <div class="font-size-15">Rp {{number_format($data['anggota']->simpanan_wajib,0,',','.')}}</div>
      </div>
      <div class="form-group">
        <p class="text-muted text-truncate mb-2">Saldo Simpanan Hari Raya</p>
        <div class="font-size-15">Rp {{number_format($data['anggota']->simpanan_hari_raya,0,',','.')}}</div>
      </div>
      <div class="form-group">
        <p class="text-muted text-truncate mb-2">Saldo Simpanan Sukarela</p>
        <div class="font-size-15">Rp {{number_format($data['anggota']->simpanan_sukarela,0,',','.')}}</div>
      </div>
      <div class="form-group">
        <p class="text-muted text-truncate mb-2">Total Saldo Simpanan</p>
        <div class="font-size-15">Rp {{number_format($data['anggota']->total_simpanan,0,',','.')}}</div>
      </div>
    </div>
  </div>
</div>
