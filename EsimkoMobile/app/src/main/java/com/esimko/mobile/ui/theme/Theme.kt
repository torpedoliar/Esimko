...
// Shape: medium-rounded — kartu & tombol senada dengan logo koperasi yang bulat
private val EsimkoShapes = Shapes(
...
fun EsimkoTheme(
    ...
    dynamicColor: Boolean = false, // brand konsisten — nonaktifkan wallpaper override
